...
CREATE TABLE `fact_trade` (
  ...
  CONSTRAINT `fact_trade_ibfk_1` FOREIGN KEY (`crop_full_code`) REFERENCES `master_crop_variety` (`crop_full_code`)
...
CREATE TABLE `fact_trade_weekly` (
  ...
  KEY `idx_j_sanji_cd` (`j_sanji_cd`),
  CONSTRAINT `fact_trade_weekly_ibfk_1` FOREIGN KEY (`crop_full_code`) REFERENCES `master_crop_variety` (`crop_full_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
